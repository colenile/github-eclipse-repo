...
<body class="background1">
 	  ...
 	  <audio id="intr" controls="controls"
		src="/static/audio/meandyou.mp3" autoplay="autoplay"></audio>
	<audio id="poem" src="/static/audio/gem.mp3"
		preload="auto"></audio>
	
    <span id="firstline" style="font-size: 22px; color: white">大家好，我是赵科淙，下面是我设计的“<span
		style="font-size: 38px; color: red">流浪地球</span>”工程！点击屏幕左下角的地球，可以开始悲壮的流浪之旅！！
	</span>
	<audio id="waiting" src="/static/audio/meandyou.mp3" preload="auto" onended="onWaitingAudioEnd();"></audio>
	<div id="poem-txt"
		style="display: none; font-size: 18px; color: orange; position:absolute; left :10px;top:50px" >
		《善待地球"》<br /> <span style="font-size: 18px; color: grey">
			-赵科淙 </span><br /> <br /> 善待地球就是善待自己，拯救地球就是拯救未来。 <br /> 但存方寸地，留与子孙耕。
	</div>
	...
	<div id="moviebox" style="margin-top: 100px; display: none"
		...
		<video id="movie" height="300px" controls="controls"
			src="/static/video/liulang.mp4" onended="onVideoEnd();" ></video>
	</div>
